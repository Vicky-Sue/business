      ...
      <el-row type="flex" class="air-sale-pic" justify="space-between">
        <div>
          <nuxt-link to="/air/flights">
            <img src="@/assets/images/canton Tower1.jpg" alt />
        ...
        <div>
          <nuxt-link to="/air/flights">
            <img src="@/assets/images/canton Tower2.jpg" alt />
            <span class="layer-bar">
              <i>广州-上海</i>
              <i>￥668</i>
            </span>
        ...
        <div>
          <nuxt-link to="/air/flights">
            <img src="@/assets/images/canton Tower3.jpg" alt />
            <span class="layer-bar">
              <i>广州-上海</i>
              <i>￥668</i>
            </span>
        ...
        <div>
          <nuxt-link to="/air/flights">
            <img src="@/assets/images/canton Tower4.jpg" alt />
            <span class="layer-bar">
              <i>广州-上海</i>
              <i>￥668</i>
            </span>
